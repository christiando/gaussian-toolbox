...
class TestGaussianDensity:
    ...
    def test_condition_on(self, R, D, dim_y):
        ...
        Lambda = jnp.eye(D)[None] * 1./rand_nums[:, None, None]
    ...
    def test_to_dict(self, R, D):
        ...
        assert jnp.allclose(d_dict['ln_det_Sigma'], jnp.sum(jnp.log(jnp.diagonal(Sigma, axis1=1, axis2=2)), axis=1), atol=1e-6)
